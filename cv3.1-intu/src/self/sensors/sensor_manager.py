...
class SensorManager(object):
    ''' Responsible for initializing all sensor objects for the local
    environment '''
    ...
    def get_instance(cls):
        ''' Return the Singlton instance of the sensor manager '''
    ...
    def find_sensor(self, data):
        ''' Return a sensor corresponding to the data '''
        for k, v in self.sensor_map.items():
